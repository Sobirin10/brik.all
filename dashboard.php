    ...
    <div class="container">
        ...
        <div class="plants">
            <div class="plant-card">
                <a href="plant_legok.php">BRIK Mix Legok</a>
            </div>
            <div class="plant-card">
                <a href="plant_cikarang.php">BRIK Mix Cikarang</a>
            </div>
            <div class="plant-card">
                <a href="plant_alam_sutera.php">BRIK Mix Alam Sutera</a>
            </div>
            <div class="plant-card">
                <a href="plant_sentul.php">BRIK Mix Sentul</a>
            </div>
            <div class="plant-card">
                <a href="plant_kelapa_gading.php">BRIK Mix Kelapa Gading</a>
            </div>
            <div class="plant-card">
                <a href="plant_karawang.php">BRIK Mix Karawang</a>
            </div>
            <div class="plant-card">
                <a href="plant_bekasi_barat.php">BRIK Mix Bekasi Barat</a>
            </div>
            <div class="plant-card ho-card">
                <a href="plant_ho.php">BRIK Mix HO</a>
            </div>
        </div>
